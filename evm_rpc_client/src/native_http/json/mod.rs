...
macro_rules! bytes_array {
    ($name: ident, $size: expr) => {
        ...
        #[serde(transparent)]
        pub struct $name(#[serde(with = "crate::eth_types::serde_data")] [u8; $size]);
...
#[serde(transparent)]
pub struct JsonByte(#[serde(with = "crate::eth_types::serde_data")] Byte);
