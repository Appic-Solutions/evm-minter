use super::{FixedSizeData, Hash, JsonByte, LogsBloom};
use crate::eth_types::Address;
use crate::evm_rpc_types::{JsonRpcError, RpcError};
use crate::native_http::eth_rpc::{HttpRequestResultPayload, ResponseTransform};
use crate::numeric::{
...
impl HttpRequestResultPayload for TransactionReceipt {
...
impl HttpRequestResultPayload for Vec<LogEntry> {
    fn response_transform() -> Option<ResponseTransform> {
...
impl HttpRequestResultPayload for Block {
    fn response_transform() -> Option<ResponseTransform> {
...
impl HttpRequestResultPayload for FeeHistory {
    fn response_transform() -> Option<ResponseTransform> {
...
impl HttpRequestResultPayload for SendRawTransactionResult {
    fn response_transform() -> Option<ResponseTransform> {
...
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
#[serde(transparent)]
pub struct Data(#[serde(with = "crate::eth_types::serde_data")] pub Vec<u8>);

impl HttpRequestResultPayload for Data {}
